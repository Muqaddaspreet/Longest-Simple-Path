...
#to solve recursion depth limit error
...
# Change this to the path to name of graph file
filename = "graph_n5.edges"
graph = read_graph_from_file(filename)
#function to calculate LCC for the given graph
vertices_lcc, edges_lcc = graph.get_largest_connected_component()
#function to Compute the longest simple path using DFS heuristic
...
Lmax = len(graph.longest_path_heuristic())
